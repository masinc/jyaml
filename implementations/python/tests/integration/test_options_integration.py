...
class TestParseOptionsIntegration:
    ...
    def test_strict_mode_enforcement(self):
        ...
        try:
            doc = parse(invalid_jyaml, strict_mode=False)
...
class TestLoadOptionsIntegration:
    ...
    def test_type_conversion_control(self):
        ...
        # Custom control
        data = loads(typed_jyaml, parse_numbers=False, parse_booleans=True, parse_null=True)
...
class TestRealWorldScenarios:
    ...
    def test_data_migration_scenarios(self):
        ...
        assert isinstance(typed_data['records'][0]['value'], str)  # "123.45" stays string
        assert isinstance(typed_data['records'][0]['active'], str)  # "true" stays string
