...
class TestJSONCompatibility:
    ...
    def test_basic_types_json_compatible(self):
        ...
        for obj in test_cases:
            ...
            assert json_result == jyaml_result, (
                f"Mismatch for {obj}: JSON={json_result!r}, JYAML={jyaml_result!r}"
            )
    ...
    def test_string_escaping_compatibility(self):
        ...
        for s in test_strings:
            ...
            jyaml_escaped = jyaml_result.split(': "')[1][
                :-2
            ]  # Remove {"text": " and "}
