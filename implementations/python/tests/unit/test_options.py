...
class TestParseOptions:
    ...
    def test_consistency_validation(self):
        ...
        assert "strict_mode and allow_duplicate_keys are incompatible" in str(
            exc_info.value
        )
        ...
        assert "include_comment_positions requires preserve_comments=True" in str(
            exc_info.value
        )
    ...
    def test_serialization(self):
        ...
        opts = ParseOptions(strict_mode=False, max_depth=200, preserve_comments=False)
...
class TestLoadOptions:
    ...
    def test_consistency_validation(self):
        ...
        assert "use_decimal and use_ordered_dict require as_native_types=True" in str(
            exc_info.value
        )
    ...
    def test_serialization_without_callables(self):
        ...
        opts = LoadOptions(use_decimal=True, use_ordered_dict=True, parse_numbers=True)
...
class TestOptionErrors:
    ...
    def test_validation_error_details(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ParseOptions(
                max_depth=-5, max_size=0, strict_mode=True, allow_duplicate_keys=True
            )
